...
<form method="post" enctype="multipart/form-data" class="upload-form">
  ...
  <label>
    ...
    <input type="file" name="files" multiple webkitdirectory mozdirectory directory required />
    <small>Supports CSV, SAS (.sas7bdat), and Parquet files. You may select an entire folder.</small>
  </label>
